...
export const MOCK_MARKETS: readonly StrikeMarket[] = [
  {
    ...
    totalPairsMinted: 150,
    totalPairsRedeemed: 12,
    settledAt: null,
  },
  {
    ...
    settlementPrice: null,
    totalPairsMinted: 230,
    totalPairsRedeemed: 18,
    createdAt: now - 2 * 3600 * 1000,
    settledAt: null,
  },
  {
  ...
  },
  {
    ...
    settlementPrice: null,
    totalPairsMinted: 310,
    totalPairsRedeemed: 45,
    createdAt: now - 2 * 3600 * 1000,
    settledAt: null,
  },
  {
    ...
    settlementPrice: null,
    totalPairsMinted: 175,
    totalPairsRedeemed: 22,
    createdAt: now - 2 * 3600 * 1000,
    settledAt: null,
  },
  {
  ...
  },
  {
    ...
    settlementPrice: null,
    totalPairsMinted: 205,
    totalPairsRedeemed: 30,
    createdAt: now - 2 * 3600 * 1000,
    settledAt: null,
  },
  // Settled market for redemption demo
  {
    ...
    totalPairsMinted: 420,
    totalPairsRedeemed: 380,
